...
export class Tool {
     ...
     * @return
     */
    private static checkParamsMeta(table: ITable<any>) {
     ...
     * @return
     */
    public static getTableName(table: ITable<any>) {
     ...
     * @return
     */
    public static getTableFieldMap(table: ITable<any>): Map<string, ColumnMeta> {
     ...
     * @return
     */
    public static getTableFieldList(table: ITable<any>): Map<string, ColumnMeta> {
        Tool.checkParamsMeta(table);
     ...
     */
    public static tableField(table: ITable<any>, field: string): IField<any> {
